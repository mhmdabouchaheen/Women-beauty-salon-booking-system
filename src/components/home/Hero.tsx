...
const buttonStyles = {
  primary:
    "inline-flex items-center justify-center rounded-full px-7 py-3 font-medium transition-all duration-300 active:scale-95 bg-rose-700 text-white shadow-lg hover:bg-rose-800 hover:shadow-xl hover:scale-105",
  outline:
    "inline-flex items-center justify-center rounded-full px-7 py-3 font-medium transition-all duration-300 active:scale-95 border border-rose-700 text-rose-700 hover:bg-rose-50 hover:scale-105",
};
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="#services" className={buttonStyles.outline}>
                Explore Services
              </a>
            </div>
          </div>
